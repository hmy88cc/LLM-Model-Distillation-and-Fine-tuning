...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name="Qwen/Qwen2.5-9B-Instruct",  # 使用9B模型
...
def get_gsm8k_questions(split="train", num_samples=100) -> Dataset:
    """加载GSM8K数据集（限制样本数）"""
...
print(f"  - 样本示例: {dataset[0]['prompt'][-1]['content'][:80]}...")
...
print("  ✓ 推理测试: 模型推理验证完成")
print("\n程序名称: Qwen3_5_(9B)_GRPO_Lightweight.py")
print("保存位置: /d:/AI CASES/30-LLM模型蒸馏与微调实操/")
