...
This project provides complete practical code for LLM (Large Language Model) distillation and fine-tuning, including Supervised Fine-Tuning (SFT), Reinforcement Learning with GRPO, and other training methods.

## 📋 Project Overview

Based on the Unsloth framework, this project implements various efficient LLM fine-tuning approaches:
- **SFT (Supervised Fine-Tuning)**: Instruction fine-tuning of Qwen2.5-7B/Qwen3.5-9B using Alpaca dataset
...
This project includes 4 core training scripts for different scenarios and models:
...
**Purpose**: Qwen3.5-9B for quick full-pipeline validation
...
#### 2. download_qwen35_9b.py - Model Download Tool
**Purpose**: Automatically download Qwen3.5-9B model from ModelScope to local storage
